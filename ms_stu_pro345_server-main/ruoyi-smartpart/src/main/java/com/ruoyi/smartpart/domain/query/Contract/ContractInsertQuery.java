...
public class ContractInsertQuery {
    ...
    @ApiModelProperty("结束时间 需求类型为yyyy-MM-dd HH:mm:ss")
     ...
     * 开始时间
     */
    @ApiModelProperty("开始时间 需求类型为yyyy-MM-dd HH:mm:ss")
    ...
    @ApiModelProperty("签订日期 需求类型为yyyy-MM-dd HH:mm:ss")
